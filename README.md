...
MODEL     They should've learned that in the second grade

    In the in the second grade I learned my times tables
    


ACTUAL     They should have learned that in the second grade
...
MODEL     Cause there are a_lot_of women out there
...
ACTUAL     don't believe in using condoms
...
MODEL     I'm the only teacher who's not experienced
...
ACTUAL     I'm the only teacher who's not experienced
...
MODEL     Well let's see



ACTUAL     Well let's see
...
MODEL     and we all heard it

    and we all
    


ACTUAL     And we all heard it
...
MODEL     cause Nancy's in the column
...
ACTUAL     cause Pete's using the colander
...
MODEL     and I'm just going



ACTUAL     Are they going
...
MODEL     I didn't even know she was pregnant

    three months ago
    


ACTUAL     I didn't even know she was pregnant
...
MODEL     cause I burned em for the past three months
...
ACTUAL     cause I've heard em for the past three months
...
MODEL     technicality that they have to meet

    Yeah
    


ACTUAL     technicality that they have to meet
...
MODEL     Whatever they do wrong

    we do get mad at em
    


ACTUAL     whatever they do wrong
...
MODEL     well you can trim em too short
...
ACTUAL     Well you can trim em too short
...
MODEL     So should I just finish it all off



ACTUAL     So should I just finish it all off
...
MODEL     and watch us pull in

    and she goes like this
    


ACTUAL     and watch us pull in
...
MODEL     That looks like enough salad
...
ACTUAL     That looks like enough salad
...
MODEL     Next thing you knew it was just overcast
...
MODEL     Do they still teach at Bahia on Sunday

    Oh yeah
    


ACTUAL     Do they still teach at Bahia on Sunday
...
ACTUAL     oh the Brazilian troop that was here
...
MODEL     I don't know how to say it
...
ACTUAL     I don't know how to say it
